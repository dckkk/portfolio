...
- Name: portfolio.spec.ts >> Portfolio Website >> Hero Section >> should display job title
- Location: tests/portfolio.spec.ts:39:5
...
Locator: locator('text=Senior Software Engineer')
Expected: visible
Error: strict mode violation: locator('text=Senior Software Engineer') resolved to 3 elements:
    1) <p class="text-2xl font-light text-blue-300 mb-2">Senior Software Engineer</p> aka getByRole('paragraph').filter({ hasText: /^Senior Software Engineer$/ })
    ...
    3) <h3 class="text-xl font-bold text-white group-hover:text-blue-400 transition">Senior Software Engineer</h3> aka getByRole('heading', { name: 'Senior Software Engineer' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Senior Software Engineer')
