...
- Name: portfolio.spec.ts >> Portfolio Website >> Experience Section >> should display experience section
- Location: tests/portfolio.spec.ts:54:5
...
Locator: locator('text=Experience')
Expected: visible
Error: strict mode violation: locator('text=Experience') resolved to 5 elements:
    1) <a href="#experience" class="hover:text-blue-400 transition">Experience</a> aka getByRole('link', { name: 'Experience' })
    2) <p class="text-lg text-slate-300 leading-relaxed text-center backdrop-blur-md bg-slate-800/50 p-8 rounded-xl border border-slate-700">Senior Software Engineer at Grab specializing in …</p> aka getByText('Senior Software Engineer at')
    3) <h2 class="text-4xl font-black mb-4 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Experience</h2> aka getByRole('heading', { name: 'Experience' })
    4) <text x="600" y="185" class="arch-text-small">Chat Widget | Profile | Skills | Experience</text> aka getByText('Chat Widget | Profile |')
    5) <text x="300" y="305" class="arch-text-small">Skills, Experience</text> aka getByText('Skills, Experience')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Experience')
