...
- Name: portfolio.spec.ts >> Portfolio Website >> API Integration >> should fetch profile data
- Location: tests/portfolio.spec.ts:131:5
...
Locator: locator('text=Dicky Pratama')
Expected: visible
Error: strict mode violation: locator('text=Dicky Pratama') resolved to 3 elements:
    1) <h1 class="text-xl font-bold">Dicky Pratama</h1> aka getByRole('navigation').getByRole('heading', { name: 'Dicky Pratama' })
    2) <h1 class="text-6xl font-black mb-3 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Dicky Pratama</h1> aka getByRole('main').getByRole('heading', { name: 'Dicky Pratama' })
    3) <p>© 2026 Dicky Pratama. Built with React, Langchain…</p> aka getByText('© 2026 Dicky Pratama. Built')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Dicky Pratama')
