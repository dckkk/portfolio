...
- Name: portfolio.spec.ts >> Portfolio Website >> Skills Section >> should display skills section
- Location: tests/portfolio.spec.ts:71:5
...
Locator: locator('text=Skills')
Expected: visible
Error: strict mode violation: locator('text=Skills') resolved to 4 elements:
    1) <a href="#skills" class="hover:text-blue-400 transition">Skills</a> aka getByRole('link', { name: 'Skills' })
    2) <h2 class="text-4xl font-black mb-4 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Skills</h2> aka getByRole('heading', { name: 'Skills' })
    3) <text x="600" y="185" class="arch-text-small">Chat Widget | Profile | Skills | Experience</text> aka getByText('Chat Widget | Profile |')
    4) <text x="300" y="305" class="arch-text-small">Skills, Experience</text> aka getByText('Skills, Experience')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Skills')
