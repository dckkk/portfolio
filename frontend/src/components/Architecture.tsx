    ...
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-lg p-8 mb-12 overflow-x-auto">
        <svg viewBox="0 0 1200 800" className="w-full min-h-[600px]" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M 600 460 L 630 520" className="arch-arrow" />
          ...
          <g transform="translate(60, 720)">
            ...
            <text x="50" y="23" className="arch-text-small" textAnchor="start" fill="#60a5fa">User Layer</text>

            <rect x="150" y="12" width="14" height="14" className="arch-box" rx="2" />
            <text x="200" y="23" className="arch-text-small" textAnchor="start" fill="#60a5fa">Frontend</text>

            <rect x="300" y="12" width="14" height="14" className="arch-box-service" rx="2" />
            <text x="350" y="23" className="arch-text-small" textAnchor="start" fill="#d946ef">Service</text>

            <rect x="450" y="12" width="14" height="14" className="arch-box-data" rx="2" />
            <text x="500" y="23" className="arch-text-small" textAnchor="start" fill="#10b981">Data/Storage</text>

            <rect x="650" y="12" width="14" height="14" className="arch-box-api" rx="2" />
            <text x="700" y="23" className="arch-text-small" textAnchor="start" fill="#fb923c">External API</text>
          </g>
        </svg>
      </div>
